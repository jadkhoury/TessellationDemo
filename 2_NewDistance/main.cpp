...
void RenderImgui()
{
    ...
    ImGui::Begin("Parameters", nullptr, ImGuiWindowFlags_AlwaysAutoResize);
    {
        ...
        {
            values_qt_gpu_compute[offset] = app.mesh.quadtree->ticks.gpu_compute * 1000.0f;
            values_qt_gpu_render[offset]  = app.mesh.quadtree->ticks.gpu_render  * 1000.0f;

            values_fps[offset] = ImGui::GetIO().Framerate;
            values_primcount[offset] = app.mesh.quadtree->full_node_count;
